...
export function CompletePayment() {
  ...
  useEffect(() => {
    ...
    stripe.retrievePaymentIntent(clientSecret).then(({ paymentIntent }) => {
      ...
      // Limpar carrinho se pagamento foi bem-sucedido e ainda não foi limpo
      if (paymentIntent.status === 'succeeded' && !cartCleared) {
        clearCart();
        setCartCleared(true);
        console.log('✅ Carrinho limpo após pagamento bem-sucedido');
      }
    });
  }, [stripe, cartCleared, clearCart]);
